...
class ClinicalTrialMatch(BaseModel):
    ...
    ClinicalTrialMatch
    """ # noqa: E501
    trial_id: StrictStr = Field(description="The unique identifier of the clinical trial", alias="trialId")
    trial_name: StrictStr = Field(description="The name of the clinical trial", alias="trialName")
    locations: List[Location]
    summary: StrictStr = Field(description="Detailed description of the clinical trial")
