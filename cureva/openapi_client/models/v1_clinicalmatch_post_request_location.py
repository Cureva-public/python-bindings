...
class V1ClinicalmatchPostRequestLocation(BaseModel):
    """
    The geographic location of the patient encounter.
    """ # noqa: E501
    latitude: Union[StrictFloat, StrictInt] = Field(description="The latitude of the location.")
    longitude: Union[StrictFloat, StrictInt] = Field(description="The longitude of the location.")
