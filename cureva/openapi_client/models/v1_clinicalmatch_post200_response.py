...
class V1ClinicalmatchPost200Response(BaseModel):
    """
    V1ClinicalmatchPost200Response
    """ # noqa: E501
    status: Optional[StrictStr] = None
    matches: Optional[List[V1ClinicalmatchPost200ResponseMatchesInner]] = None
    __properties: ClassVar[List[str]] = ["status", "matches"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "matches": [V1ClinicalmatchPost200ResponseMatchesInner.from_dict(_item) for _item in obj["matches"]] if obj.get("matches") is not None else None
        })
        return _obj
