...
class TestV1ClinicalmatchPost200Response(unittest.TestCase):
    """V1ClinicalmatchPost200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1ClinicalmatchPost200Response:
        """Test V1ClinicalmatchPost200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1ClinicalmatchPost200Response`
        """
        model = V1ClinicalmatchPost200Response()
        if include_optional:
            return V1ClinicalmatchPost200Response(
                status = 'success',
                matches = [
                    openapi_client.models._v1_clinicalmatch_post_200_response_matches_inner._v1_clinicalmatch_post_200_response_matches_inner(
...
There is no effective treatment for NPC and it is a lethal disorder. A major impediment to the testing of therapeutic interventions is the lack of well-defined outcome measures. The purpose of this protocol is to obtain both baseline and rate of progression data on clinical and biochemical markers that may later be used as an outcome measure in a clinical trial.', 
    ...
    def testV1ClinicalmatchPost200Response(self):
        """Test V1ClinicalmatchPost200Response"""
